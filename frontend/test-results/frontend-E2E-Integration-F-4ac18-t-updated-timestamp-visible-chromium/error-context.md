...
- Name: frontend.spec.ts >> E2E Integration Flows >> E2E-009: SEP data auto-refresh — last updated timestamp visible
- Location: tests\frontend.spec.ts:542:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/sep
Call log:
  - navigating to "http://localhost:3000/sep", waiting until "load"
