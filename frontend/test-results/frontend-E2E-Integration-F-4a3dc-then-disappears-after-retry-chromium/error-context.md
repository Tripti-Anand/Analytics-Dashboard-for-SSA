...
- Name: frontend.spec.ts >> E2E Integration Flows >> E2E-006: Retry flow — error banner appears when API is mocked to fail then disappears after retry
- Location: tests\frontend.spec.ts:479:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/solar-wind
Call log:
  - navigating to "http://localhost:3000/solar-wind", waiting until "load"
